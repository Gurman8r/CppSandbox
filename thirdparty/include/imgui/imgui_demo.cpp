...
// We splitNode the contents of the big ShowDemoWindow() function into smaller functions (because the link time of very large functions grow non-linearly)
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // If your items are of variable size you may want to implement code similar to what ImGuiListClipper does. Or splitNode your data into fixed height items to allow random-seeking into your list.
