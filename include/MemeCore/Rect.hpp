...
namespace ml
{
	...
	public: // Member Functions
		...
		inline self_type & left		(const value_type value)	{ ((*this)[0] = value); return (*this); }
		inline self_type & top		(const value_type value)	{ ((*this)[1] = value); return (*this); }
		inline self_type & width	(const value_type value)	{ ((*this)[2] = value); return (*this); }
		inline self_type & height	(const value_type value)	{ ((*this)[3] = value); return (*this); }
		inline self_type & bot		(const value_type value)	{ return height(value - top()); }
		inline self_type & right	(const value_type value)	{ return width(value - left()); }
